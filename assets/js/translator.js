...
var contact3Element = document.getElementById('contact3');
...
switchLangButton.addEventListener('click', function() {
  if (currentLang === 'es') {
    ...
    contact3Element.textContent = 'Do you have any questions? Send me a message';
    ...
    enviarElement.textContent = 'Send';
    ...
    contact3Element.textContent = 'Tienes alguna pregunta? Enviame un mensaje';
    ...
    subjectElement.textContent = 'Asunto';
    messageElement.textContent = 'Mensaje';
    enviarElement.textContent = 'Enviar';
